...
class OpStudent(models.Model):
    ...
    full_name = fields.Char("Full Name", translate=False)
    # first_name = fields.Char('First Name',  translate=False)
    # middle_name = fields.Char('Middle Name', translate=False)
    # last_name = fields.Char('Last Name', translate=False)
    birth_date = fields.Date("Birth Date")
    place_of_birth = fields.Char("Place of Birth")
    blood_group = fields.Selection(
        [("A", "A"), ("B", "B"), ("O", "O"), ("AB", "AB")], string="Blood Group"
    )
